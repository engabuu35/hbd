...
const m = {
  ...
  seconds: 0,
  onEnd: () => {
    const button = document.getElementById('lihat-undangan');
    if (button) {
      button.removeAttribute('disabled'); // Aktifkan tombol
      button.style.cursor = 'pointer'; // Opsional: ubah tampilan tombol
      button.style.backgroundColor = '#ff69b4'; // Opsional: ubah warna tombol
    }
  },
  refresh: 1e3,
